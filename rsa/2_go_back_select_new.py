...
def get_args():
    ...
    parser.add_argument('--fig_dir', type=str, default='outputs/ablation_consistency/thresh05_show', help='Directory for figures')
    parser.add_argument('--save_dir', type=str, default='outputs/ablation_consistency/thresh05', help='Directory to save outputs')
    parser.add_argument('--record_save_name', type=str, default='outputs/ablation_consistency/record05.json', help='Directory to save outputs')
    ...
    parser.add_argument('--var_thresh', type=float, default=0.5, help='Variance threshold')
